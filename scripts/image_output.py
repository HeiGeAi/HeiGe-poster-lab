...
Copied from heige-image/scripts/image_output.py and namespaced for
naked-eye posters. Keeps the same safety guarantees: bounded size,
PNG magic check, chunk validation, CRC verification, atomic writes.
"""
