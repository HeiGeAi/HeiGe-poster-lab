...
- 主题：把 Crush 变成宠物
- 主标题：一句话，把 Crush 变成宠物！
- 比例：2.35:1（实际映射到横桶 1536×1024）
- 平台：公众号封面 / 小红书横图
...
Asset type: high-impact youth-magazine poster, exact aspect ratio 2.35:1.
Input image: the bundled approved poster is a STYLE-AND-DEPTH reference only, not an edit target.

Primary concept: A mysterious editorial subject captures the magical moment of turning a crush into an obedient pet through one sentence.
Exact primary headline, rendered once and spelled perfectly:
“一句话，把 Crush 变成宠物！”
Hero keyword: “Crush”. Make it the largest contrasting typographic element.
...
LAYER 2 — floating foreground: a glossy heart-shaped pet collar, a torn speech bubble, a glowing cursor arrow at different scales; crop one at the frame and make another overlap the headline.
LAYER 3 — middle-ground subject: a deep blue-black editorial silhouette of a young woman with electric rim light, her hand reaching out as if taming invisible energy. Weave the subject through the type: one edge sits behind the hero word while another luminous strand breaks in front of secondary graphics. Add a floating paw-print charm as the concept reveal.
...
Output: polished high-resolution raster art, 2.35:1 cinematic wide ratio.
```
